...
----
dependencies {
    griffon '{project-group}:griffon-db4o-plugin:{project-version}'
}
----
...
----
dependencies {
    compile '{project-group}:griffon-db4o-core:{project-version}'
}
----
...
----
dependencies {
    compileOnly '{project-group}:griffon-db4o-groovy-compile:{project-version}'
}
----

== Maven

First configure the `griffon-db4o-plugin` BOM in your POM file, by placing the following
